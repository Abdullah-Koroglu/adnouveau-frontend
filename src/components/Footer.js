...
const FirstElement = ({className}) => {
  return <div className={`w-full md:w-1/2 lg:w-1/3 flex justify-start items-center pt-4 lg:pt-0  flex-row lg:gap-5 text-neutral-500 ${className}`}>
...
export default function Footer() {
  ...
  return (
    <div className="footer flex justify-between items-center flex-wrap overflow-hidden text-neutral-300 font-medium px-4 md:px-8 lg:px-16 3xl:w-2/3 mx-auto pb-8">
      ...
      <div className="w-2/3 md:w-1/2 lg:w-1/3 flex flex-col md:flex-row gap-2 text-neutral-500 lg:px-2">
      ...
      <div className="w-1/3 md:w-1/2 lg:w-1/3  flex flex-col md:flex-row gap-2 text-neutral-500 lg:px-2">
        <Link className="hover:text-black hover:dark:text-white transition-all w-1/3" out="true" href="https://www.behance.net/adnouveau" target="_blank" rel="noopener noreferrer">Behance</Link>
        ...
        <Link className="hover:text-black hover:dark:text-white transition-all w-1/3" out="true" href="https://www.instagram.com/ad_nouveau" target="_blank" rel="noopener noreferrer">Instagram</Link>
      </div>
